...
\begin{figure}[!htp]
    ...
    \includegraphics[width=\textwidth]{../input/figure_city.jpg}
...
\begin{figure}[!htp]
    ...
    \includegraphics[width=\textwidth]{../input/figure_hwy.jpg}
...
\begin{table}[htp]
    \centering
    \caption{\bf{Regression Results with Clustered SEs}}
